...
# Memory: ipl_memory
MEM_1 := cineraria_de0_boot
$(MEM_1)_NAME := ipl_memory
...
$(MEM_1)_END := 0x0f001fff
$(MEM_1)_HIERARCHICAL_PATH := ipl_memory
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: ipl_memory
ipl_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
